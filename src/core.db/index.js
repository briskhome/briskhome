...
import type { CoreOptions, CoreImports, CoreRegister } from '../utilities/coreTypes';

export default (options: CoreOptions, imports: CoreImports, register: CoreRegister) => {
  ...
  let credentials = '';
  if (username) credentials = password ? `${username}:${password}@` : `${username}@`;
