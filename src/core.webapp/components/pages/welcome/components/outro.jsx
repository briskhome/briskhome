...
import type { WizardOutroProps } from '../../../wizard/types';
...
type OwnProps = {
  ...
  history: any,
  loading: boolean,
  wizard: { slides: { firstName: string, lastName: string, password: string } },
};

export class OutroSlide extends React.Component<
  WizardOutroProps & OwnProps,
  {},
> {
        ...
        {!loading && (
          <React.Fragment>
            ...
            <Button
              ...
              className="briskhome-wizard__button-next"
