...
describe('core.webapp -> ui -> checkbox', () => {
  it('renders', () => {
    expect(
      toJson(
        render(
          <Checkbox name="example" checked={false} onChange={() => null} />,
        ),
      ),
    ).toMatchSnapshot();
  });
  it('renders checked', () => {
    expect(
      toJson(
        render(
          <Checkbox name="example" checked={true} onChange={() => null} />,
        ),
      ),
    ).toMatchSnapshot();
  });
  it('renders disabled', () => {
    expect(
      toJson(
        render(<Checkbox name="example" checked={true} disabled={true} />),
      ),
    ).toMatchSnapshot();
  });
