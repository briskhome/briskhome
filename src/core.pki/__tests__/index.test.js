...
describe('core.pki', () => {
  ...
  describe('#generateRequest()', () => {
    ...
    it.skip('should yield error if unable to generate a CSR', async () => {
      // forge.mockReturnValueOnce({ pki: { rsa: {
    ...
    it.skip('should yield error if unable to verify a CSR', async () => {
    ...
    it.skip('should yield error if unable to save a CSR', () => {
