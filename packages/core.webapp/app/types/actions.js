/** @flow */
import type { User, Wizard } from './';
import type { WizardSlideState } from '../../components/wizard/types';
...
export type WizardGotoAction = {
  type: '@@WIZARD/GOTO',
  value: { slide: number, state?: WizardSlideState },
};
