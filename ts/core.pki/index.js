...
export default ((imports: CoreImports) => {
  ...
  PKI.prototype.issueCertificate = function issue()
  /* data */
  {
    return new Promise(() =>
    /* resolve, reject */
    {
      ...
      cert.publicKey = keys.publicKey; // alternatively set public key from a csr
      ...
      cert.setSubject(attrs); // alternatively set subject from a csr
      ...
      */
      ...
      cert.sign(keys.privateKey); // convert a Forge certificate to PEM
  ...
  PKI.prototype.signData = function sign(data) {
    return new Promise((resolve, reject) => {
      if (!data || !Object.prototype.hasOwnProperty.call(data, 'signer') || !Object.prototype.hasOwnProperty.call(data, 'inkey') || !Object.prototype.hasOwnProperty.call(data, 'certfile')) {
