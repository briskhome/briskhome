...
export class CreateAccountSlide extends React.Component<WizardSlideProps, CreateAccountSlideState> {
  ...
  render(): React.Fragment {
    ...
    return <React.Fragment>
        ...
        <Input name="first-name" autoComplete="given-name" placeholder="First name" valid={!errors.includes('E_INVALID_FIRSTNAME')} onFocus={this.resetErrors.bind(this)} onChange={({
        target: {
          value
        }
      }) => this.setState({
        ...
        <Input name="last-name" autoComplete="family-name" placeholder="Last name" valid={!errors.includes('E_INVALID_LASTNAME')} onFocus={this.resetErrors.bind(this)} onChange={({
        target: {
          value
        }
      }) => this.setState({
