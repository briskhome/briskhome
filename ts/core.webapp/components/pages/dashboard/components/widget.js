...
export const DashboardWidget = ({
  ...
  return <div className={cn('dashboard-widget', {
    [`dashboard-widget__${id}`]: id
  })}>
      <div className="dashboard-widget__header">
        ...
        <div className="dashboard-widget__header-button">
          <MenuButton {...menuProps} menu={<Dropdown>
                <MenuList className={`${className}__list`}>
                  {menu.map(item => <MenuItem className={`${className}__item`} {...item}>
                      {item.title}
                    </MenuItem>)}
                  <hr className={`${className}__separator`} />
                  <MenuItem className={cn(`${className}__item`, `${className}__item_red`)}>
                    Hide widget
                  </MenuItem>
                </MenuList>
              </Dropdown>}>
