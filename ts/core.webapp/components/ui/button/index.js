...
export default (({
  ...
  onClick,
  children
}: ButtonProps) => <a className={cn('briskhome-button', {
...
}, className)} role="button" type={type || 'button'} disabled={loading || disabled} href={link || '#'} target={target || '_self'} onClick={onClick}>
