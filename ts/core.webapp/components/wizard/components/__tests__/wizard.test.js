...
describe('core.webapp -> components -> wizard', () => {
  ...
  it('renders', () => {
    expect(toJson(render(<Wizard store={store} slides={[MockSlide]} />))).toMatchSnapshot();
  });
  it('renders with intro', () => {
    ...
    expect(toJson(render(<Wizard store={store} intro={MockIntro} slides={[MockSlide]} />))).toMatchSnapshot();
  });
  it('renders with outro', () => {
    ...
    expect(toJson(render(<Wizard store={store} outro={MockOutro} slides={[MockSlide]} />))).toMatchSnapshot();
  });
